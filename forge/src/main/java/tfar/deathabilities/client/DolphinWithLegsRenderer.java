...
public class DolphinWithLegsRenderer extends GeoEntityRenderer<DolphinWithLegsEntityGeo> {
    ...
    @Override
    public boolean shouldRender(DolphinWithLegsEntityGeo pLivingEntity, Frustum pCamera, double pCamX, double pCamY, double pCamZ) {
        if (super.shouldRender(pLivingEntity, pCamera, pCamX, pCamY, pCamZ)) {
            ...
            if (pLivingEntity.hasActiveAttackTarget()) {
                ...
                if (livingentity != null) {
                    Vec3 vec3 = this.getPosition(livingentity, livingentity.getBbHeight() * 0.5D, 1.0F);
    ...
    @Override
    public void render(DolphinWithLegsEntityGeo pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        if (livingentity != null) {
            ...
            Vec3 vec3 = this.getPosition(livingentity, livingentity.getBbHeight() * 0.5D, pPartialTicks);
            ...
            float f8 = f * f;
            int red = 64 + (int)(f8 * 191.0F);
            int green = 32 + (int)(f8 * 191.0F);
            int blue = 128 - (int)(f8 * 64.0F);
            float f9 = 0.2F;
            float f10 = 0.282F;
            ...
            vertex(vertexconsumer, matrix4f, matrix3f, f19, f4, f20, red, green, blue, 0.4999F, f30);
            ...
            vertex(vertexconsumer, matrix4f, matrix3f, f21, f4, f22, red, green, blue, 0.0F, f30);
            vertex(vertexconsumer, matrix4f, matrix3f, f23, f4, f24, red, green, blue, 0.4999F, f30);
            ...
            vertex(vertexconsumer, matrix4f, matrix3f, f25, f4, f26, red, green, blue, 0.0F, f30);
            float f31 = 0.0F;
            if (pEntity.tickCount % 2 == 0) {
                f31 = 0.5F;
            }

            vertex(vertexconsumer, matrix4f, matrix3f, f11, f4, f12, red, green, blue, 0.5F, f31 + 0.5F);
            vertex(vertexconsumer, matrix4f, matrix3f, f13, f4, f14, red, green, blue, 1.0F, f31 + 0.5F);
            vertex(vertexconsumer, matrix4f, matrix3f, f17, f4, f18, red, green, blue, 1.0F, f31);
            vertex(vertexconsumer, matrix4f, matrix3f, f15, f4, f16, red, green, blue, 0.5F, f31);
