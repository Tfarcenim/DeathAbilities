...
public enum ElementalDragonRespawnAnimation {
    START {
        public void tick(ServerLevel p_64017_, EndElementalDragonFight p_64018_, List<EndCrystal> p_64019_, int p_64020_, BlockPos p_64021_) {
    ...
    PREPARING_TO_SUMMON_PILLARS {
        public void tick(ServerLevel p_64026_, EndElementalDragonFight p_64027_, List<EndCrystal> p_64028_, int p_64029_, BlockPos p_64030_) {
            if (p_64029_ < 100) {
    ...
    SUMMONING_PILLARS {
        public void tick(ServerLevel p_64035_, EndElementalDragonFight p_64036_, List<EndCrystal> p_64037_, int p_64038_, BlockPos p_64039_) {
            int i = 40;
    ...
    SUMMONING_DRAGON {
        public void tick(ServerLevel p_64044_, EndElementalDragonFight p_64045_, List<EndCrystal> p_64046_, int p_64047_, BlockPos p_64048_) {
            if (p_64047_ >= 100) {
    ...
    END {
        public void tick(ServerLevel p_64053_, EndElementalDragonFight p_64054_, List<EndCrystal> p_64055_, int p_64056_, BlockPos p_64057_) {
        }
    };

    public abstract void tick(ServerLevel pLevel, EndElementalDragonFight pManager, List<EndCrystal> pCrystals, int pTicks, BlockPos pPos);
}