...
public class ElementalDragonStrafePlayerPhase extends AbstractElementalDragonPhaseInstance {
   ...
   private void navigateToNextPathNode() {
      if (this.currentPath != null && !this.currentPath.isDone()) {
         ...
         double d1;
         do {
            d1 = (float)vec3i.getY() + this.dragon.getRandom().nextFloat() * 20.0F;
   ...
   @Override
   public ElementalDragonPhase<ElementalDragonStrafePlayerPhase> getPhase() {
      return ElementalDragonPhase.STRAFE_PLAYER;
   }
}