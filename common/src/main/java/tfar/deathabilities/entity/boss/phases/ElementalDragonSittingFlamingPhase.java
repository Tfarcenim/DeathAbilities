...
public class ElementalDragonSittingFlamingPhase extends AbstractElementalDragonSittingPhase {
   ...
   public void doClientTick() {
      ++this.flameTicks;
      if (this.flameTicks % 2 == 0 && this.flameTicks < WARMUP_TIME) {
   ...
   public void doServerTick() {
      ++this.flameTicks;
      if (this.flameTicks >= FLAME_DURATION) {
   ...
   @Override
   public ElementalDragonPhase<ElementalDragonSittingFlamingPhase> getPhase() {
      return ElementalDragonPhase.SITTING_FLAMING;
   }
