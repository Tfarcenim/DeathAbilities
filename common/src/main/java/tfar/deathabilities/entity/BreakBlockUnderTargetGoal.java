...
public class BreakBlockUnderTargetGoal extends Goal {
    ...
    public BreakBlockUnderTargetGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;
    ...
    protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
        ...
        if (pDistToEnemySqr <= d0 && this.ticksUntilNextAttack <= 0) {
            ...
            this.mob.level().destroyBlock(pEnemy.blockPosition().below(),true);
